...
import com.store.cloud.rbac.dto.MenuDTO;
...
import com.store.cloud.rbac.vo.RouteMetaVO;
import com.store.cloud.rbac.vo.RouteVO;
...
public class MenuController {
	...
	private Menu checkAndGenerate(@RequestBody @Valid MenuDTO menuDTO) {
		...
		if(!Objects.equals(userInfoInTokenBO.getTenantId(),0L)){
			throw new StorecloudException("无权限操作！");
		}
