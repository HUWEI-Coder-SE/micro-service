package com.store.cloud.api.product.manager;
...
import com.store.cloud.api.product.dto.ShopCartItemDTO;
...
import com.store.cloud.api.product.vo.SpuAndSkuVO;
    ...
    public List<ShopCartVO> conversionShopCart(List<ShopCartItemVO> shopCartItems){
        ...
        for (Long shopId : shopCartMap.keySet()) {
            ...
            if (!shopNameResponse.isSuccess()) {
                throw new StorecloudException(shopNameResponse.getMsg());
            }
