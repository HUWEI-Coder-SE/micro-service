...
import com.store.cloud.api.vo.*;
import com.store.cloud.api.vo.search.*;
...
import com.store.cloud.search.constant.*;
...
public class ProductSearchManager {
    ...
    public List<SpuSearchVO> list(ProductSearchDTO productSearchDTO) {
        ...
        try {
            ...
            throw new StorecloudException("搜索服务出了点小差，请稍后再试", e);
        }
        return spuList;
    }
