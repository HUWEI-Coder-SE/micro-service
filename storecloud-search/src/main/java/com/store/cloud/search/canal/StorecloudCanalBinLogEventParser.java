 ...
 */
public class StorecloudCanalBinLogEventParser implements CanalBinLogEventParser {
    ...
    private StorecloudCanalBinLogEventParser() {
    }

    public static StorecloudCanalBinLogEventParser of() {
        return new StorecloudCanalBinLogEventParser();
    }
}
