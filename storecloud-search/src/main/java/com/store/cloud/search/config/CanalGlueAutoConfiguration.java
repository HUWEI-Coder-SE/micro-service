package com.store.cloud.search.config;
...
import com.store.cloud.search.canal.StorecloudCanalBinLogEventParser;
import com.store.cloud.search.canal.StorecloudCanalBinlogEventProcessorFactory;
import com.store.cloud.search.canal.StorecloudCanalGlue;
...
public class CanalGlueAutoConfiguration implements SmartInitializingSingleton, BeanFactoryAware {
    ...
    public CanalBinlogEventProcessorFactory canalBinlogEventProcessorFactory() {
        return StorecloudCanalBinlogEventProcessorFactory.of();
    }
    ...
    public CanalBinLogEventParser canalBinLogEventParser() {
        return StorecloudCanalBinLogEventParser.of();
    }
    ...
    public CanalGlue canalGlue(CanalBinlogEventProcessorFactory canalBinlogEventProcessorFactory) {
        return StorecloudCanalGlue.of(canalBinlogEventProcessorFactory);
    }
