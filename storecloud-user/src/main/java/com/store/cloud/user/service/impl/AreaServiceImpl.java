...
import com.store.cloud.api.user.vo.AreaVO;
import com.store.cloud.common.cache.constant.CacheNames;
import com.store.cloud.common.exception.StorecloudException;
import com.store.cloud.user.mapper.AreaMapper;
import com.store.cloud.user.model.Area;
import com.store.cloud.user.service.AreaService;
...
public class AreaServiceImpl implements AreaService {
    ...
    public void deleteById(Long areaId) {
        ...
        if (areaNum > 0) {
            throw new StorecloudException("请先删除子地区");
        }
