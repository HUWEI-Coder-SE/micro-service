...
import com.store.cloud.user.dto.UserAddrDTO;
import com.store.cloud.user.model.UserAddr;
...
public class UserAddrController {
    ...
    public ServerResponseEntity<Void> delete(@RequestParam Long addrId) {
        ...
        if (dbUserAddr == null) {
            ...
            throw new StorecloudException("默认地址不能删除");
        }
