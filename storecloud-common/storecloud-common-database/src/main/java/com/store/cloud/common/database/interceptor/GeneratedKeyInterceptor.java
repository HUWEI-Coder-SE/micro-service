package com.store.cloud.common.database.interceptor;

import com.store.cloud.api.leaf.feign.SegmentFeignClient;
import com.store.cloud.common.database.annotations.DistributedId;
import com.store.cloud.common.exception.StorecloudException;
import com.store.cloud.common.model.BaseModel;
...
/**
 * 分布式id生成
 * 1. 分布式id是通过美团的leaf生成的，是需要与storecloud-leaf数据库 当中 leaf_alloc表中 biz_tag字段相关联的key
