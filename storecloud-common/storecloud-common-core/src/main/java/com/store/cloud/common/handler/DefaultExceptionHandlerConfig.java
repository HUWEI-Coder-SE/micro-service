package com.store.cloud.common.handler;
...
public class DefaultExceptionHandlerConfig {
	...
	@ExceptionHandler(StorecloudException.class)
	public ResponseEntity<ServerResponseEntity<Object>> StorecloudExceptionHandler(StorecloudException e) {
		logger.error("StorecloudExceptionHandler", e);
