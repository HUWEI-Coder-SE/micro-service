package com.store.cloud.payment.service.impl;
...
import com.store.cloud.payment.bo.PayInfoResultBO;
import com.store.cloud.payment.constant.PayStatus;
import com.store.cloud.payment.dto.PayInfoDTO;
import com.store.cloud.payment.mapper.PayInfoMapper;
import com.store.cloud.payment.model.PayInfo;
...
public class PayInfoServiceImpl implements PayInfoService {
    ...
    public PayInfoBO pay(Long userId, PayInfoDTO payParam) {
        ...
        if (!ordersAmountAndIfNoCancelResponse.isSuccess()) {
            throw new StorecloudException(ordersAmountAndIfNoCancelResponse.getMsg());
        }
