...
import com.store.cloud.product.constant.AttrType;
import com.store.cloud.product.mapper.AttrMapper;
import com.store.cloud.product.model.Attr;
import com.store.cloud.product.model.AttrValue;
import com.store.cloud.product.mapper.AttrValueMapper;
import com.store.cloud.product.model.SpuAttrValue;
import com.store.cloud.product.service.AttrValueService;
import com.store.cloud.api.product.vo.AttrVO;
import com.store.cloud.api.product.vo.AttrValueVO;
import com.store.cloud.product.service.SpuAttrValueService;
